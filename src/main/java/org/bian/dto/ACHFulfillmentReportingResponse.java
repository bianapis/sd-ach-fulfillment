...
/**
 * ACHFulfillmentReportingResponse
 */
public class ACHFulfillmentReportingResponse   {
  private String achAccessServiceSessionReference = null;

  private String achAccessSchedule = null;

  private String achReportingServiceReference = null;
  ...
  private String achReportingServiceResult = null;
  ...
  **/
  ...
  /**
   * Get achReportingServiceReference
   * @return achReportingServiceReference
  **/

  public String getAchReportingServiceReference() {
    return achReportingServiceReference;
  }

  public void setAchReportingServiceReference(String achReportingServiceReference) {
    this.achReportingServiceReference = achReportingServiceReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text     
   * @return achReportingServiceResult
  **/

  public String getAchReportingServiceResult() {
    return achReportingServiceResult;
  }

  public void setAchReportingServiceResult(String achReportingServiceResult) {
    this.achReportingServiceResult = achReportingServiceResult;
  }
